    ...
    public partial class Products : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (selectedRow != null)
            {
                ...
                decimal price = Convert.ToDecimal(selectedRow.Cells["Column2"].Value);

                ChangeProducts changeProducts = new ChangeProducts(name, price);
                changeProducts.ShowDialog(this);
            }
        }

        private void DeleteProductFromDatabase(int rowIndex)
        {
            using (SQLiteConnection conn = new SQLiteConnection("Data Source=D:\\Курсовая работа\\TradingCompanies.db"))
            {
                ...
                string deleteQuery = "DELETE FROM Products WHERE ROWID = @RowIndex";
                ...
                string updateQuery = "UPDATE Products SET ROWID = ROWID - 1 WHERE ROWID > @RowIndex";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                DeleteProductFromDatabase(rowIndex);
